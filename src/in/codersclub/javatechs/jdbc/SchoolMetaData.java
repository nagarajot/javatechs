...
create view male_teachers as select id, name, gender from teachers where gender = 'M';
select * from male_teachers;

create view science_teachers as select id, name, gender, qualification from teachers where qualification = 'MSc';
select * from science_teachers;
*/
